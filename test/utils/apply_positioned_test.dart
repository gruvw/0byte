...
Tuple2<ConversionType, PositionedText> _positionedFromReadable(String readable) {
...
void main() {
  group("Display separator enabled", () {
    ...
    test("Digit addition creates correct separator before position", () {
      testApplyPositioned(displaySeparator, "0x01|_11", "0x011|_11", "0x0_11|_11");
    });
    ...
    test("Text made invalid removes separator after cursor", () {
      testApplyPositioned(displaySeparator, "0x00|_11", "0x00z|_11", "0x00z|11");
    });
    test("Text made invalid removes every separator", () {
      testApplyPositioned(displaySeparator, "0x00_11|_22", "0x00_11z|_22", "0x0011z|22");
    });
    test("Text made invalid removes every separator (binary)", () {
      testApplyPositioned(
          displaySeparator, "0b10_10_10|_11_00", "0b10_10_10a|_11_00", "0b101010a|1100");
    });
    ...
    test("Input separator in middle of word", () {
      testApplyPositioned(displaySeparator, "0x0|0_11", "0x0_|0_11", "0x0|0_11");
    });
    test("Input separator at start of word", () {
      testApplyPositioned(displaySeparator, "0x|00_11", "0x_|00_11", "0x|00_11");
    });
    test("Input separator next to separator", () {
      testApplyPositioned(displaySeparator, "0x00_|11", "0x00__|11", "0x00_|11");
    });
    test("ASCII don't separate", () {
      testApplyPositioned(displaySeparator, "0aabc|defghijklmnop...", "0aabcz|defghijklmnop...",
          "0aabcz|defghijklmnop...");
    });
    test("ASCII don't use separator", () {
      testApplyPositioned(displaySeparator, "0a|", "0a_|", "0a_|");
    });
    test("Decimal separation (unsigned)", () {
      testApplyPositioned(displaySeparator, "0d1234|6789", "0d12345|6789", "0d123_45|6_789");
    });
    test("Decimal separation (signed)", () {
      testApplyPositioned(displaySeparator, "0s-1234|6789", "0s-12345|6789", "0s-123_45|6_789");
    });
  ...
  group("Additional usage tests", () {
    ...
    test("Middle word deletion should stay between separators", () {
      testApplyPositioned(displaySeparator, "0x01_11|_11", "0x01_1|_11", "0x0_11|_11");
    });
    test("Middle word deletion should respect separator groups reduction", () {
      testApplyPositioned(displaySeparator, "0x0_11|_11", "0x0_1|_11", "0x01|_11");
    });
    test("Invalid letter addition", () {
      testApplyPositioned(displaySeparator, "0x0z|FF1", "0x0zF|FF1", "0x0zF|FF1");
    });
    test("Invalid letter addition with separators after position", () {
      testApplyPositioned(displaySeparator, "0x0z|FF__1", "0x0zF|FF__1", "0x0zF|FF__1");
    });
    test("Invalid letter deletion", () {
      testApplyPositioned(displaySeparator, "0x0zF|FF1", "0x0z|FF1", "0x0z|FF1");
    });
    test("Made invalid at position 1", () {
      testApplyPositioned(displaySeparator, "0x0|0_FF_F1", "0x0z|0_FF_F1", "0x0z|0FFF1");
    });
    ...
    test("Added digit correct separator side (after)", () {
      testApplyPositioned(displaySeparator, "0x0|_FF_01", "0x0F|_FF_01", "0x0F|_FF_01");
    });
    test("Added digit correct separator side (after)", () {
      testApplyPositioned(displaySeparator, "0x0_|FF_01", "0x0_F|FF_01", "0x0F|_FF_01");
    });
    test("Added digit correct separator side (lower)", () {
      testApplyPositioned(displaySeparator, "0x0_11|_11_11", "0x0_11a|_11_11", "0x01_1A|_11_11");
    });
    test("Added digit correct separator side (lower)", () {
      testApplyPositioned(displaySeparator, "0x0_11|_11_11", "0x0_11a|_11_11", "0x01_1A|_11_11");
    });
